		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="home.php">EduVid</a>
				</div>
				...
				<div class="container" style="margin-top:70px">
					<div class="btn pull-right">
						<div class="col-md-12 form-group">
							<form method="get" action="https://1410inc.xyz/video-call-app/">
								<button type="submit">Voice Chat</button>
							</form>
						</div>
					</div>
				...
				<div id="about" class="container text-center"style="color: #000000; height: 400px; background-color: #C0C0C0;">
					<h1>EduVid.com</h1>
					<pre>EduVid.com is a learning website where viewers are mastering new skills and achieving heir goals.</pre> 
				...
				<div id="contact" class="container bg-grey">
					...
					<div class="row">
						<div class="col-md-4" style="color: white;">
							...
							<p><span class="glyphicon glyphicon-envelope"></span>Email: EduVid@gmail.com</p>
						</div>
						<div class="col-md-8">
							<div class="row">

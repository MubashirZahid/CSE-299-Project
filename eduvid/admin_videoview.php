							...
							<tbody>
								<?php
									...
									if ($result->num_rows > 0) {
										...
										<tr>
											<td><?php echo $i?></td>
											<td><a href="http://localhost/EduVid/video/<?php echo $row['video_path']?>"><?php echo $row['video_path']?></a></td>
											<td><?php echo $row['video_ext']?></td>
											<td><a href="http://localhost/EduVid/video/<?php echo $row['thumbnail_path']?>"><?php echo $row['thumbnail_path']?></a></td>
